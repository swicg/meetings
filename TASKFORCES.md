## Current SWICG Task Forces and status
...
| [Trust and Safety](https://github.com/swicg/activitypub-trust-and-safety) | 2024-09-06 | Improving the trust, safety, and integrity of ActivityPub and related specifications |  | @thisismissem, @dariusk | [Initial report](https://swicg.github.io/activitypub-trust-and-safety/initial-report/) |
...
| [ActivityPub API](https://github.com/swicg/activitypub-api) | APIs for more efficient fetching from outbox & inbox, media uploads, partial updates, and an OAuth 2.x profile for interacting with the API | | @ThisIsMissEm, @evanp |  |
...
| Website | Update and maintain all public SWICG-related websites and accounts | 2024-09-06 | @jernst | ongoing work |
| | | | @evanp | [Process for Including Extensions in Activity Streams 2.0](https://swicg.github.io/extensions-policy/) (draft)
